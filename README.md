...
<ul>
	...
	<li>理论流量: 在不考虑泄漏的情况下, 单位时间内所输出的液体的体积,<markup><math><msub><mi>q</mi><mi>t</mi></msub><mo>=</mo><mi>V</mi><mi>n</mi></math></markup>;</li>
	<li>实际流量: 泵工作时的输出流量, 需考虑泄漏量Δq,<math><mi>q</mi><mo>=</mo><msub><mi>q</mi><mi>t</mi></msub><msub><mi>&eta;</mi><mi>pv</mi></msub></math>;</li>
